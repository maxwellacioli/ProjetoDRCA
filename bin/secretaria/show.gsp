...
<html>
    ...
    <body>
        ...
        <div id="show-secretaria" class="content scaffold-show" role="main">
            ...
            <f:display bean="secretaria" />
            <g:form resource="${this.secretaria}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.secretaria}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
